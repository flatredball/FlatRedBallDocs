# glue-reference-loadedonlywhenreferenced
...
* [Optionally Loaded Content tutorial](../../../../frb/docs/index.php) - Basic tutorial on how to use optionally loaded content.
* [Optionally Loaded Scenes](../../../../frb/docs/index.php) - Discusses how to create optionally loaded Scenes (.scnx files) to load levels dynamically.

...
Since the game is nearly feature-complete after the [second part of this tutorial series](../frb/docs/index.php), you should attach more importance to how your code is organized. At the moment everything is placed in a single code file. Thatâ€™s fine for the beginning but will be a pain when your project grows. Furthermore there should be a frame to the game. The game should start with a menu screen where you can start the game. After finishing the game, the menu screen should appear again. To convert the game into a Screen you need to learn how to create Screens. You will learn that in the following tutorial chapter â€œCreate a templateâ€?: [Screen:How to use Screens](../frb/docs/index.php) After downloading the template, create a new Screen named GameScreen and add it to your project.

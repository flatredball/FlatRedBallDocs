...
![](../../../media/2023-01-img\_63bed29eca1f8.png)
...
Now the Enemy flashes white when taking damage. Note that to test this you may want to disable the enemy shooting logic added in the previous tutorial. Also, you may want to adjust the health of the enemy to take more hits. [![](../../../media/2023-01-11\_08-19-19.gif)](../../../media/2023-01-11\_08-19-19.gif) The purpose of ReactToDamageDealt is to react to damage visually, or to perform other game logic outside of typical IDamageable logic. Therefore, ReactToDamageDealt should not:
...
Now ice enemies die after 5 hits instead of 10 since each bullet will do an effective 20 points of damage. [![](../../../media/2023-01-11\_08-54-38.gif)](../../../media/2023-01-11\_08-54-38.gif)
...
This tutorial discusses how to handle events to modify damage and display visual feedback to the player when damage is dealt. The next tutorial covers the removal of IDamageAreas and how to implement damage over time. -- [04 - IDamageArea Removal ->](04-idamagearea-removal.md)

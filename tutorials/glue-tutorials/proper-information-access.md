...
The simplest approach to sharing information is to make it global. In C#, that means to define it as "public static". The broadest form of global data is generally placed in a class called GlobalData. The GlobalData class is commonly used to provide **access** to data in your game. For information on how to write a public static GlobalData class, see [this page](../../../frb/docs/index.php). First, let's consider the type of data we would want to put in GlobalData. The general rule is that information should be accessible through GlobalData if all of the following are true:

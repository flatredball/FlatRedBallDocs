...
![](../.gitbook/assets/2020-10-img_5f920612a27d5.png)
...
![](../.gitbook/assets/2020-01-img_5e32406153abb-e1581456365306.png)
...
![](../.gitbook/assets/2018-04-img_5ac384828b05a.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a273ddcac.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a5294d5f7.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a586b4085.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a62503bce.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a736695e4.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a7c7ee002.png)
...
![](../.gitbook/assets/2018-04-img_5ac3a816a6e4f.png)
...
### Components in Entities and Zooming

As mentioned, Gum components are "Gum on the inside, FlatRedBall on the outside". This means that Gum coordinates are based on the Gum coordinate system which ignores camera scaling. This can be seen easily if an object is given a pixel offset but the FlatRedBall camera zooms. The following animation shows a component with a health bar. The health bar is given an offset of -36 pixels on the Gum component, so the offset is not affected by FlatRedBall Camera zoom.

<figure><img src="../.gitbook/assets/02_09 50 28.gif" alt=""><figcaption></figcaption></figure>

The Y value here is the **Gum** Y variable, so it is in Gum coordinates.

The entire object can be offset using FlatRedBall coordinates, but this must be done in code. For example, the following code could be used to offset the health bar object in code:

```csharp
var wrapper = gumAttachmentWrappers.First(
    item => item.GumObject == HealthBarInstance);

wrapper.RelativeY = 36;
```

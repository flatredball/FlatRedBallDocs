...
-   The [IAttachable](/frb/docs/index.php?title=FlatRedBall.Math.IAttachable.md "FlatRedBall.Math.IAttachable") is added to the collection of items that the AttachableList stores.

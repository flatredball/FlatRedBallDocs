...
5.  Select the .entz file and select OK. For more information on importing, see [the Importing Entities tutorial here](/frb/docs/index.php?title=Glue:Reference:Entities:Import_Entity "Glue:Reference:Entities:Import Entity").

...
The first step is to create the If and Do functions that will be available in our game script. I won't cover the steps here because they are identical to the implementation tutorial [which can be found here|which can be found here](../../../../../frb/docs/index.php). In short the setup is:

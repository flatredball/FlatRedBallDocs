...
CSV (comma separated values) is a spreadsheet file format which has extensive support in FlatRedBall and Glue. For information on how to use CSVs in Glue, see the ["Using CSVs" article](../../../../tutorials/glue-tutorials/glue-tutorials-using-csvs.md). For more information on how to combine CSVs with Entities, see ["How To Combine CSVs with Entities" article](../../../../../uncategorized/glue-how-to-combine-csvs-with-entities.md).
...
For a full list of supported types, see the [CsvManager page](../../../../api/flatredball/io/csv/csvfilemanager.md).

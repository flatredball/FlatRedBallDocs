...
If you have an existing project which already has a Gum project, then by default your project will receive a new Gum screen any time you add a new Glue screen. [![](/media/2021-05-2021_May_13_112104.gif)](/media/2021-05-2021_May_13_112104.gif) This behavior is default, and it can be controlled by selecting the .gumx file.

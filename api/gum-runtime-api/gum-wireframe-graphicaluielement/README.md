...
All GraphicalUiElement instances implement the IWindow interface, which means that they can be used just like other FlatRedBall UI elements. For example, all GraphicalUiElements have a Click event which can be subscribed to. For more information on the IWindow interface, see [the IWindow page](../../../../frb/docs/index.php).

### Additional Information

* [Working with Screens in code](../../../../frb/docs/index.php)

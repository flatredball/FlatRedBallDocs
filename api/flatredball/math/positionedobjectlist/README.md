...
The PositionedObjectList is a dynamic list which is made to specifically store [PositionedObjects](../../../../../frb/docs/index.php) and any classes which inherit from [PositionedObject](../../../../../frb/docs/index.php). The most common types stored in PositionedObjectLists are:
...
* **Particles with special behavior** - Particles that have behavior not handled by the [Emitter](../../../../../frb/docs/index.php) may need to be stored in a PositionedObjectList for their custom behavior. For example, you may need to perform collision between rain particles and the ground, and destroy the rain particle upon collision.

#### PositionedObjectList life

In most cases PositionedObjectLists should be defined at class (usually [Screen](../../../../../frb/docs/index.php) scope. The reason for this is mainly because the categories that the PositionedObjectList represents will usually live the entire life of the [Screen](../../../../../frb/docs/index.php). The objects within the PositionedObjectList may have a short life (bullets may only have a few seconds); however, the list itself should only be created in the [Screen's](../../../../../frb/docs/index.php) Initialize method. All PositionedObjectLists should be emptied when their containing [Screen](../../../../../frb/docs/index.php) is destroyed. See the next section for information about how to properly remove items from PositionedObjectLists.
...
For a more detailed discussion of the Clear function and why it may not be a good idea to use it, see the [Clear wiki page](../../../../../frb/docs/index.php).
...
* [FlatRedBall.Math.PositionedObjectList.Add](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.AttachTo](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.Clear](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.GetFirstAfter](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.GetFirstAfterPosition](../../../../../frb/docs/index.php) (Obsolete)
* [FlatRedBall.Math.PositionedObjectList.SortXInsertionAscending](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.SortXInsertionDescending](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.SortYInsertionAscending](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.SortYInsertionDescending](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.SortZInsertionAscending](../../../../../frb/docs/index.php)
* [FlatRedBall.Math.PositionedObjectList.SortZInsertionDescending](../../../../../frb/docs/index.php)

...
The following code creates a [Sprite](../../../../frb/docs/index.php) from a graphic which has a magenta background. The bool ifUsingColorKey controls whether the color key is set to Magenta or not - the default color is Black. Files used: Add the following to Initialize after initializing FlatRedBall:
...
Setting the ifUsingColorKey to false will result in a magenta box being drawn around the redball graphic. ![ColorKey.png](../../../../.gitbook/assets/migrated_media-ColorKey.png)
